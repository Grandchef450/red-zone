...
-- Touche/commande d'ouverture du panneau admin (aussi lançable depuis rz_admintablet)
Config.OpenKey = 'F11'

Config.Debug = true

-- =========================================================
--  PERMISSIONS (memes cles CFX que rz_admintablet)
--  1) Le serveur lit automatiquement admins.json de la
--     ressource rz_admintablet (si demarree) → tous tes
...
-- =========================================================
-- Ressource optionnelle : si une tablette admin existe un jour et
-- expose un admins.json, ses admins seront acceptes automatiquement.
-- Elle n'existe pas aujourd'hui, d'ou la permission ACE ci-dessous.
Config.AdminTabletResource = 'rz_admintablet'

-- PERMISSION PRINCIPALE — c'est celle qui fonctionne aujourd'hui.
--   server.cfg :  add_ace group.admin rz.jail allow
Config.Ace = 'rz.jail'

-- Identifiants en dur, en secours (fondateurs).
-- Format : 'license:xxxxxxxx'. Laisser vide si tu utilises l'ACE.
Config.ExtraAllowed = {
