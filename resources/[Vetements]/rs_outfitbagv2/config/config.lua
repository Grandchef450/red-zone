...
Config.Debug = false -- If true, you will get an additional F8 prints for what's going on
...
Config.Target = 'ox_target' -- qb-target, qtarget, ox_target, custom - change in cl_edit.lua
-- or you can set it to 'auto' and it will detect the target automatically

Config.TextUI = 'ox_lib' -- ox_lib = Ox lib text ui, esx_textui = ESX Text ui,custom - change in cl_edit.lua
