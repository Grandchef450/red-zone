...
-- Dynasty 8 : la gestion immobilière (agent) est réservée aux admins via cette permission ace,
-- accordée à group.admin dans permissions.cfg. Les jobs ci-dessous ne donnent plus l'accès.
Config.RealtorAce = 'dynasty8.admin'

-- Set your Real Estate jobs here (ne donne plus l'accès au menu ; sert seulement à la commission de vente)
