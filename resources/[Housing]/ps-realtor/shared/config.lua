...
-- Dynasty 8 : accès au menu agent réservé aux admins via cette permission ace
-- (accordée à group.admin dans permissions.cfg). Doit être identique à ps-housing.
Config.RealtorAce = 'dynasty8.admin'

-- Set your Real Estate jobs here (non utilisé : voir Config.RealtorAce)
