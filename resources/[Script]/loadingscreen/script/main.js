...
var texts = ["Chargement en cours", "Préparation des assetes", "Établisement de la connection "];
var currentText = 0;
...
(function welcometext() {
    var welcomes = ['Votre survie dépend de vous.', 'Votre détermination et votre allié.', 'Cherchez et trouvez des objets pour tous fabriquer.', 'Vendez ou troquez vos objets ou fabrications.', 'Sans votre Clan, survivre est impossible.', ];
